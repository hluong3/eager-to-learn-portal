    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<JwtBearerOptions>(JwtBearerDefaults.AuthenticationScheme, options =>
                {
                    options.TokenValidationParameters.ValidAudience = "97fe09bd-b942-422e-a03e-891d7aa7dedf";
                    options.TokenValidationParameters.ValidIssuer = $"https://sts.windows.net/137e5a2f-32be-4811-b649-15bcce76b74/";
                });
